...
router.post('/',function(req,res,next){
    ...
    var fileName = 'zhaoling'+method.getNowFormatDate()+'.jpg';
    
    var base64Data = zhaolingpic.replace(/^data:image\/\w+;base64,/, "");
    ...
    fs.writeFile('./public/images/'+fileName, dataBuffer, function(err) {
        if(err){
          ...
          pool.getConnection(function (err, connection) { 
                ...
                var sql = 'insert into zhaoling (title,zhaolingpic) values(\''+title+'\',\''+avatarName+'\')';
