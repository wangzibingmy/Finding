...
router.post('/',function(req,res,next){
    ...
    var fileName = 'people_search'+method.getNowFormatDate()+'.jpg';
    
    var base64Data = peoplepic.replace(/^data:image\/\w+;base64,/, "");
    ...
    fs.writeFile('./public/images/'+fileName, dataBuffer, function(err) {
        if(err){
          ...
          pool.getConnection(function (err, connection) { 
                ...
                var sql = 'insert into people_search (peoptitle,peoplepic) values(\''+peoptitle+'\',\''+avatarName+'\')';
